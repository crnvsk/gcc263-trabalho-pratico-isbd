...
<body>
    ...
    <h2>Buscar Usuário por genero</h2>
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="get">
        <label for="genero">Genero (M ou F):</label>
    ...
    <?php
        ...
        if($_SERVER["REQUEST_METHOD"] == "GET"){
            if(isset($_GET["genero"])){
                ...
                $sql = "SELECT * FROM Usuario WHERE genero = '$genero'";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "Nenhum usuário encontrado com o genero '" . $genero . "'.";
                }
            }
        }
    ?>
